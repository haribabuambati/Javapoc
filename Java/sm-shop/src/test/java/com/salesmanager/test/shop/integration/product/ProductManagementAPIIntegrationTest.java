...
public class ProductManagementAPIIntegrationTest extends ServicesTestSupport {
    ...
    public void createOptionValue() throws Exception {
        ...
        final ResponseEntity response = restTemplate.postForEntity("https://poctesting.azurewebsites.net/sm-shop/services/private/DEFAULT/product/optionValue", entity, PersistableProductOptionValue.class);
    ...
    public void createOption() throws Exception {
        ...
        final ResponseEntity response = restTemplate.postForEntity("https://poctesting.azurewebsites.net/sm-shop/services/private/DEFAULT/product/option", entity, PersistableProductOption.class);
    ...
    public void getProducts() throws Exception {
        ...
        final ResponseEntity<ReadableProduct[]> response = restTemplate.exchange("https://poctesting.azurewebsites.net/sm-shop/services/rest/products/DEFAULT/en/" + testCategoryID, HttpMethod.GET, httpEntity,
    ...
    public void postProduct() throws Exception {
        ...
        final ResponseEntity response = restTemplate.postForEntity("https://poctesting.azurewebsites.net/api/v1/product", entity, PersistableProduct.class);
    ...
    public void deleteProduct() throws Exception {
        ...
        restTemplate.exchange("https://poctesting.azurewebsites.net/sm-shop/services/rest/product/DEFAULT/en/" + testCategoryID + "/" + testProductID, HttpMethod.DELETE, httpEntity, ReadableProduct.class);
